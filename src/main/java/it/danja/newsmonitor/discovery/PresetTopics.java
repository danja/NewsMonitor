...
public class PresetTopics {
    ...
    static {
        ...
        DEEP_LEARNING.addKeyword("keras", 0.7F);
        DEEP_LEARNING.addKeyword("nolearn", 0.7F);
        DEEP_LEARNING.addKeyword("neural", 0.7F);
        DEEP_LEARNING.addKeyword("network", 0.7F);
        DEEP_LEARNING.addKeyword("ai", 0.7F);
        DEEP_LEARNING.addKeyword("vgg", 0.7F);
        DEEP_LEARNING.addKeyword("softmax", 0.7F);
        DEEP_LEARNING.addKeyword("node", 0.7F);
        DEEP_LEARNING.addKeyword("activation", 0.7F);
        DEEP_LEARNING.addKeyword("mnist", 0.7F);
        DEEP_LEARNING.addKeyword("lstm", 0.7F);
        DEEP_LEARNING.addKeyword("googlelenet", 0.7F);
        DEEP_LEARNING.addKeyword("droput", 0.7F);
        DEEP_LEARNING.addKeyword("caffe", 0.7F);
        DEEP_LEARNING.addKeyword("rnn", 0.7F);
        DEEP_LEARNING.addKeyword("backpropagation", 0.7F);
        DEEP_LEARNING.addKeyword("pooling", 0.7F);
        DEEP_LEARNING.addKeyword("autoencoder", 0.7F);
        DEEP_LEARNING.addKeyword("alexnet", 0.7F);
        DEEP_LEARNING.addKeyword("attention", 0.7F);
        DEEP_LEARNING.addKeyword("affine", 0.7F);
        DEEP_LEARNING.addKeyword("adam", 0.7F);
        DEEP_LEARNING.addKeyword("adadelta", 0.7F);
        DEEP_LEARNING.addKeyword("adagrad", 0.7F);
        DEEP_LEARNING.addKeyword("relu", 0.7F);
