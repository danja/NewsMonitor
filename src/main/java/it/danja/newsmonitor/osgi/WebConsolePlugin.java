...
@Properties({
		@Property(name = "felix.webconsole.label", value = "newsmonitor"),
		@Property(name = "felix.webconsole.title", value = "NewsMonitor") })
...
//	private LdRenderer ldRenderer;
	...
	public static final String NAME = "NewsMonitor";
	public static final String LABEL = "newsmonitor";
...
//		ldRenderer.render(userManager.getUserType(), 
	...
	protected String[] getCssReferences() {
        ...
        result[0] = "newsmonitor/res/static/newsmonitor/css/webconsole.css";
		return result;
    }
	...
	public URL getResource(String path){
		if(path.startsWith(STATIC_PREFIX)){
            //we just get the resources from the same place as stanbol expects them to be
            //i.e. the resources will be available below
            //http://<host>/<path/to/webconsole>/newsmonitor/res/
