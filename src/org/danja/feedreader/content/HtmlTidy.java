...
public class HtmlTidy {
	...
	public static void main(String[] args) {
		...
		tidy.clean(is, System.out); // run tidy, providing an input and output
									// stream
	}
	...
	public void init() {
		...
		if (!Config.JTIDY_SHOW_WARNINGS) { 
			jTidy.setShowErrors(0);
			jTidy.setQuiet(true);
			jTidy.setErrout(null);
		}
		// see
		// http://jtidy.sourceforge.net/apidocs/index.html?org/w3c/tidy/Tidy.html
